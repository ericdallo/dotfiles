...
void GestureTypeEnum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GestureTypeEnum::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GestureTypeEnum::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GestureTypeEnum,
      qt_meta_data_GestureTypeEnum, &staticMetaObjectExtraData }
};
