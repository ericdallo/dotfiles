...
void WindowListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        WindowListener *_t = static_cast<WindowListener *>(_o);
        switch (_id) {
        case 0: _t->windowCreated((*reinterpret_cast< Window(*)>(_a[1]))); break;
...
const QMetaObjectExtraData WindowListener::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WindowListener::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WindowListener,
      qt_meta_data_WindowListener, &staticMetaObjectExtraData }
};
