...
void Touchegg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Touchegg *_t = static_cast<Touchegg *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Touchegg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Touchegg::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_Touchegg,
      qt_meta_data_Touchegg, &staticMetaObjectExtraData }
};
