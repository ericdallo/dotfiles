...
hi MatchParen ctermfg=255 ctermbg=6 cterm=bold guifg=#FFFFFF guibg=#585858 gui=bold
...
"}}}
" Clojure"{{{
    hi clojureParen ctermfg=11 ctermbg=NONE cterm=bold guifg=#AF5FFF guibg=NONE gui=bold
    hi clojureDefine ctermfg=13 ctermbg=NONE cterm=bold guifg=#AF5FFF guibg=NONE gui=bold
"}}}
